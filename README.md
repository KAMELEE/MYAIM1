...
## واجهة رئيسية — تحديث ثانٍ (سبتمبر 2026)
- **هيرو واقعي**: صورة حقيقية مع تدرّج تعتيم وCTA واحد واضح — أُزيلت
  بلاطات المزايا وشارات التقييم العائمة.
- **أكاديميات مميزة**: خانة إعلانات للمتدربين على الرئيسية (كروت بصور
  حقيقية ووسم «إعلان»).
- **نشر ستوري وإعلان من لوحة الأكاديمية**: إجراءان جديدان يضيفان ستوري
  للمتدربين أو إعلاناً في خانة «أكاديميات مميزة» (FeaturedStore مشترك).
- **إصلاح صفحة اكتشف**: هوامش لشرائح الأقسام، شارة الفلاتر داخل حدود
  الزر، ومسافة آمنة من شريط التبويب للخريطة وشبكة التحميل.
